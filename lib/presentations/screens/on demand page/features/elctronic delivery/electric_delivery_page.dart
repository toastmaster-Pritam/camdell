...
import 'package:camdell/presentations/screens/on%20demand%20page/features/elctronic%20delivery/model/electronic_models.dart';
...
class ElectronicDeliveryPage extends StatefulWidget {
  const ElectronicDeliveryPage({super.key});

  @override
  State<ElectronicDeliveryPage> createState() => _ElectronicDeliveryPageState();
}

class _ElectronicDeliveryPageState extends State<ElectronicDeliveryPage> {
 ...
 final List<Stores> stores = [
  ...
  Widget build(BuildContext context) {
    return AppScaffold(title: AppText("Electronic Delivery", style: Ts.semiBold20(color: AppColor.white),),
       ...
       child: Padding(
         ...
         child: Column(
          ...
          children: [
           ...
           const Hbox(20),
           SizedBox(
             height:screenHeight(context) * 0.3,child: ElectronicItems()),
